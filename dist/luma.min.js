(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.luma = f()}})(function(){var define,module,exports;return (function(){function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s}return e})()({1:[function(require,module,exports){
...
var File = function () {
  ...
  _createClass(File, null, [{
    ...
    value: function addChangeListener(element) {
    ...
    key: 'displayFileName',
    value: function displayFileName(element) {
      if (element.files.length > 0) {
        var fileNameElement = element.parentNode.querySelector('.file__name');
...
var Select = function () {
  ...
  _createClass(Select, null, [{
    key: 'style',
    value: function style(select) {
      if (select.children.length > 0) {
        (0, _styleselect2.default)(select);
      }
    }
  }]);
...
},{"styleselect":1}],5:[function(require,module,exports){
'use strict';
...
var Textarea = function () {
  ...
  _createClass(Textarea, null, [{
    ...
    value: function addInputListener(element) {
    ...
    key: 'resizeTextarea',
    value: function resizeTextarea(element) {
...
var luma = Object.create(null);

luma.alert = function (selector) {
  if ((typeof selector === 'undefined' ? 'undefined' : _typeof(selector)) === 'object') {
    var close = selector.querySelector('.alert__close');
    if (close) new _Alert2.default(close);
  } else {
    Array.prototype.forEach.call(document.querySelectorAll(selector), function (element) {
      var close = element.querySelector('.alert__close');
      if (close) new _Alert2.default(close);
    });
  }
};

luma.textarea = function (selector) {
  if ((typeof selector === 'undefined' ? 'undefined' : _typeof(selector)) === 'object') {
    _Textarea2.default.addInputListener(selector);
  } else {
    Array.prototype.forEach.call(document.querySelectorAll(selector), function (element) {
      _Textarea2.default.addInputListener(element);
    });
  }
};

luma.select = function (selector) {
  if ((typeof selector === 'undefined' ? 'undefined' : _typeof(selector)) === 'object') {
    _Select2.default.style(selector);
  } else {
    Array.prototype.forEach.call(document.querySelectorAll(selector), function (element) {
      _Select2.default.style(element);
    });
  }
};

luma.file = function (selector) {
  if ((typeof selector === 'undefined' ? 'undefined' : _typeof(selector)) === 'object') {
    _File2.default.addChangeListener(selector);
  } else {
    Array.prototype.forEach.call(document.querySelectorAll(selector), function (element) {
      _File2.default.addChangeListener(element);
    });
  }
};

Array.prototype.forEach.call(document.querySelectorAll('[data-dismiss="alert"]'), function (element) {
  new _Alert2.default(element);
});
Array.prototype.forEach.call(document.querySelectorAll('[data-resize="textarea"]'), function (element) {
  _Textarea2.default.addInputListener(element);
});
Array.prototype.forEach.call(document.querySelectorAll('[data-style="select"]'), function (element) {
  _Select2.default.style(element);
});
Array.prototype.forEach.call(document.querySelectorAll('[data-display="file"]'), function (element) {
  _File2.default.addChangeListener(element);
});
...
var closeNav = function closeNav(sidebar, toggleButton) {
  toggleButton.classList.remove('is-active');
  sidebar.classList.remove('is-open');
};

var openNav = function openNav(sidebar, toggleButton) {
  toggleButton.classList.add('is-active');
  sidebar.classList.add('is-open');
};

luma.nav = function () {
  var mobileBar = document.querySelector('.nav.is-toggle');
  var toggleButton = mobileBar.querySelector('.hamburger');
  var sidebar = document.querySelector('.nav.is-responsive');
...
luma.navSlideOut = function () {
  ...
  document.body.addEventListener('touchend', function (e) {
    ...
    if (Math.abs(xDiff) > Math.abs(yDiff)) {
      if (xDiff > 0 && start.x <= 80) openNav(sidebar, toggleButton);else closeNav(sidebar, toggleButton);
    }
  });
};

exports.default = luma;

},{"./Alert":2,"./File":3,"./Select":4,"./Textarea":5}]},{},[6])(6)
});
